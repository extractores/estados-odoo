                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="#" class="logo logo-dark">
                                ...
                                <span class="logo-lg">
                                    <img src="{{asset('assets/images/logo-sm.svg')}}" alt="" height="24"> <span class="logo-txt">MASIVO</span>
                                </span>
                            </a>
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow">
                                    ...
                                    <span data-key="t-apps">Masivo</span>
                                </a>
               ...
               @yield('contenidos')
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6">
                                <script>document.write(new Date().getFullYear())</script> © UAT.
                            </div>
                            <div class="col-sm-6">
                                <div class="text-sm-end d-none d-sm-block">
                                    Unidad Administrativa <a href="#!" class="text-decoration-underline">Tributaria</a>
                                </div>
                            </div>
                        </div>
                    </div>
